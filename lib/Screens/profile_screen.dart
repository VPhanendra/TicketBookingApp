      ...
      body: ListView(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(borderRadius: BorderRadius.circular(AppLayout.getHeight(10)),
                    ...
                    child: Row(
                      children: [
                        Container(
                          ...
                          child:
                          Icon(FluentSystemIcons.ic_fluent_shield_filled,color: Colors.white,size: 15,),
                        ),
                        Gap(AppLayout.getHeight(5)),
                        Text("Primium status" ,style: TextStyle(
              ...
              Column(
                children: [
                  ...
                  InkWell(
                    onTap: (){
                      print("your are taped");
                    },
                      child: Text("Edit",style: Styles.textStyle.copyWith(color: Styles.primaryColor,fontWeight: FontWeight.w300,fontSize: 20),))
                ],
              )
            ],
          ),
          ...
          Container(
            ...
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              AppColumLayout(firstText: "23 042", secondText: "Miles",
                alignment: CrossAxisAlignment.start, isColor: false,),

              AppColumLayout(firstText: "Airline CO", secondText: "Received from",
            ...
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              AppColumLayout(firstText: "24", secondText: "Miles",
                alignment: CrossAxisAlignment.start, isColor: false,),

              AppColumLayout(firstText: "McDonal\'s", secondText: "Received from",
                alignment: CrossAxisAlignment.end, isColor: false,),
            ],
          ),
              Gap(AppLayout.getHeight(12)),
            ...
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              AppColumLayout(firstText: "52 340", secondText: "Miles",
                alignment: CrossAxisAlignment.start, isColor: false,),

              AppColumLayout(firstText: "DBestech", secondText: "Exuma",
                alignment: CrossAxisAlignment.end, isColor: false,),
            ],
          ),
                ],
